...
+ (NSString *)getFriendsCircleDateFormat:(NSDate*)date {
    ...
    NSString*string=[NSString stringWithFormat:@"%02d:%02d",hour,minute];
    if(year==t_year&&month==t_month&&day==t_day){
        
    } else if([todayString isEqualToString:refDateString]){
        string=[NSString stringWithFormat:@"昨天 %@",string];
    } else{
        string=[NSString stringWithFormat:@"%d/%02d/%02d %@",year,month,day,string];
    }
...
+ (NSString*)getTimeStrStyle4:(NSDate *)date today:(NSDate*)today
{
    ...
    else if(distance<60*60*24*7)
    {
        ...
        string=[NSString stringWithFormat:@"星期%@ %02d:%02d",daystr,hour,minute];
    }
    else if(year==t_year)
        string=[NSString stringWithFormat:@"%02d-%02d %02d:%02d",month,day,hour,minute];
    else
        string=[NSString stringWithFormat:@"%02d-%0d-%0d %02d:%02d",year%100,month,day,hour,minute];
...
+ (NSString*)getMonthAndDayAndHourAndMiniteTimeStr:(NSTimeInterval)timeInterval
{
    ...
    NSInteger unitFlags = NSMonthCalendarUnit | NSDayCalendarUnit|NSYearCalendarUnit|NSHourCalendarUnit|NSMinuteCalendarUnit|NSSecondCalendarUnit;
    NSDateComponents * component=[calendar components:unitFlags fromDate:date];
    NSString * string=[NSString stringWithFormat:@"%02d-%02d-%02d", [component year], [component month], [component day]];
    return string;
}
...
+ (NSString*)getMonthDayYearTimeStr:(NSTimeInterval)timeInterval{
    ...
    NSInteger unitFlags = NSMonthCalendarUnit | NSDayCalendarUnit|NSYearCalendarUnit|NSHourCalendarUnit|NSMinuteCalendarUnit|NSSecondCalendarUnit;
    NSDateComponents * component=[calendar components:unitFlags fromDate:date];
    NSString * string=[NSString stringWithFormat:@"%02d年%02d月%02d日", [component year], [component month], [component day]];
    return string;
}
@end
