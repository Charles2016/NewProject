...
// 一级导航栏颜色
#define kColorNavBgFrist    UIColorHex(0xfdb933)
// 二级及二级以上导航栏颜色
#define kColorNavBgOther    UIColorHex(0xfafafa)
// 页面底色
#define kColorViewBg        UIColorHex(0xf7f7f7)
// 深灰色
#define kColorDarkgray UIColorHex(0x666666)
// 淡灰色-如辅助说明颜色
#define kColorLightgray UIColorHex(0xbbbbbb)
// 灰色—如内容字体颜色
...
// 橙色
#define kColorOrange UIColorHex(0xff6600)
// 深橙色
