...
#define kMaxCodeLength                6  // 验证码最大长度限制
...
#define kMaxPhoneLength               11 // 手机号长度限制
...
#define kMaxAddressLength                 200 // 地址长度限制
#define kMaxMessageLength           100 // 留言长度限制
#define kMaxCommentLength           300 // 评论长度限制
