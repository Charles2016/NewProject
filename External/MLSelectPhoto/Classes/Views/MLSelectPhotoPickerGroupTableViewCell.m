...
- (void)setGroup:(MLSelectPhotoPickerGroup *)group{
    ...
    [[MLPhotoTool sharePhotoTool] getFirstThumbWithAssetGroup:group.assetsGroup sourceType:MLSourcePhoto complete:^(UIImage *thumbImage) {
        self.groupImageView.image = thumbImage;
    }];
